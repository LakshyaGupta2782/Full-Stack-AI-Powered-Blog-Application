...
const Blog = () => {
  ...
  return data?(
    <div className="relative">
      ...
      <div className='mx-5 max-w-2xl md:mx-auto my-5 mt-2'>
            <img src={data.image} alt="" className='rounded-2xl mb-5' />
            <div
           ...
           <div className='mt-14 mb-10 max-w-3xl mx-auto'>
              <p className='font-semibold nb-4'>Comments ({comments.length})</p>
